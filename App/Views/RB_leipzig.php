  ...
  <!--  image -->
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="index.html"><span style="color: #db4444;">Accueil</span></a>/ <a href="en_cours.html" style="color: #db4444;">Equipes</a> / <a href="bundesliga.html" style="color: #db4444;">Bundesliga</a> / <a href=""><span style="color: #db4444;">RB Leipzig</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football  RB_leipzig</h1>
        <h4 class="mb-3">2023/2024</h4>
       <p>Les <a href=""><span style="color: #db4444;">maillots football</span></a> des clubs de la Bundesliga sont répertoriés dans cette catégorie :<a href=""><span style="color: #db4444;">Bayern Munich</span></a><a href=""><span style="color: #db4444;"> ou </span></a><a href=""><span style="color: #db4444;">le </span></a><a href=""><span style="color: #db4444;"> Leipzig RB</span></a>,<a href=""><span style="color: #db4444;">...</span></a></p>
    </div>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/RB Leipzig 1.jpg" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">NIKE</h5>
                  <p class="card-text">Maillots Domicile authentique  RB_leipzig </p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_leipzig_domicile.html" class="btn btn-primary">Plus de détails</a>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/RB Leipzig 2.jpg" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">NIKE</h5>
                    <p class="card-text">Maillots Extérieur authentique RB_leipzig</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_leipzig_ext.html" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/RB Leipzig 3.jpg" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">NIKE</h5>
                    <p class="card-text">Maillots Third authentique RB_leipzig</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_leipzig_third.html" class="btn btn-primary">Plus de détails</a>
