...
<body>
    ...
    <!--  image -->
    <div>
        <img src="assets/imgs/produits/liste/image 68.png" class="img-fluid" alt="Wild Landscape" /> 
    </div>
    <!--  image -->
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="index.html"><span style="color: #db4444;">Accueil</span></a>/ <a href="en_cours.html" style="color: #db4444;">Equipes</a> / <a href="laliga.html" style="color: #db4444;">La liga</a> / <a href="athletic_bilbao.html"><span style="color: #db4444;">Athletic Bilbao</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football du Athletic Bilbao</h1>
        <h4 class="mb-3">2023/2024</h4>
       <p>Les <a href=""><span style="color: #db4444;">maillots football</span></a> des clubs de la liga espagnole sont répectorié dans cette catégorie :<a href=""><span style="color: #db4444;">Réal Madrid</span></a>,<a href=""><span style="color: #db4444;">Barça</span></a>,<a href=""><span style="color: #db4444;">Atlético Madrid</span></a>,<a href=""><span style="color: #db4444;">Valance</span></a>,<a href=""><span style="color: #db4444;">...</span></a></p>
    </div>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/Maillot/athletic-home-2023-2024.webp" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">CASTORE</h5>
                  <p class="card-text">Maillots Domicile authentique Athletic Bilbao</p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_bilbao_domicile.html" class="btn btn-primary">Plus de détails</a>
                  <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/Maillot/athletic-away-2023-2024.webp" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">CASTORE</h5>
                    <p class="card-text">Maillots Extérieur authentique Athletic Bilbao</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_bilbao_ext.html" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/Maillot/ath-third-2023-2024.webp" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">CASTORE</h5>
                    <p class="card-text">Maillots Third authentique Athletic Bilbao</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_bilbao_third.html" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">100,00€</span> 80,00€</p>
                </div>
              </div>
            </div>
