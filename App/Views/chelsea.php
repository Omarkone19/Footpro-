...
<body>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="Accueil"><span style="color: #db4444;">Accueil</span></a>/ <a href="Equipes" style="color: #db4444;">Equipes</a> / <a href="premier_league" style="color: #db4444;">Première League</a> / <a href="chelsea"><span style="color: #db4444;">Chelsea</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football de Chelsea</h1>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/chelsea 1.jpeg" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">NIKE</h5>
                  <p class="card-text">Maillots Domicile authentique Chelsea</p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_chelsea_domicile" class="btn btn-primary">Plus de détails</a>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/chelsea 2.jpeg" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">NIKE</h5>
                    <p class="card-text">Maillots Extérieur authentique Chelsea</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_chelsea_ext" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/chelsea 3.jpeg" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">NIKE</h5>
                    <p class="card-text">Maillots Third authentique Chelsea</p>
                    <p class="card-text">2023/2024</p>
                    <a href="products_chelsea_third" class="btn btn-primary">Plus de détails</a>
