...
<body>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="index.html"><span style="color: #db4444;">Accueil</span></a>/ <a href="en_cours.html" style="color: #db4444;">Equipes</a> / <a href="lige1.html" style="color: #db4444;">Ligue 1</a> / <a href="lille.html"><span style="color: #db4444;">LOSC</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football de Lille</h1>
        <h4 class="mb-3">2023/2024</h4>
       <p>Les <a href=""><span style="color: #db4444;">maillots football</span></a> des clubs de la ligue 1 sont répertorié dans cette catégorie :<a href=""><span style="color: #db4444;">Paris SG</span></a>,<a href=""><span style="color: #db4444;">OM</span></a>,<a href=""><span style="color: #db4444;"> MONACO ou encore</span></a><a href=""><span style="color: #db4444;"> OGC Nice</span></a>,<a href=""><span style="color: #db4444;">...</span></a></p>
    </div>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/lille 1.jpeg" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">NB</h5>
                  <p class="card-text">Maillots Domicile authentique LOSC</p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_losc_domicile.html" class="btn btn-primary">Plus de détails</a>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/lille 2.jpeg" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">NB</h5>
                    <p class="card-text">Maillots Extérieur authentique LOSC</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_losc_ext.html" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/lille 3.webp" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">NB</h5>
                    <p class="card-text">Maillots Third authentique LOSC</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_losc_third.html" class="btn btn-primary">Plus de détails</a>
