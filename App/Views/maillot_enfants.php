...
<html lang="en">
  ...
  <body>
    ...
    <!--  image -->
    <div>
        <img src="assets/imgs/produits/maillot enfant/image 97.png" class="img-fluid" alt="Wild Landscape" /> 
    </div>
    <!--  image -->
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="<?= URL ?>Accueil"><span style="color: #db4444;">Accueil</span></a>/ <a href="" style="color: black;">Enfants</a> / <a href="" style="color: black;"><!--un truc au bon vouloir--></a>  <a href=""><span style="color: #db4444;"><!--un truc au bon vouloir--></span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Tout les maillots et chaussures de football <br> pour enfants </h1>
        <!-- <h4 class="mb-3"></h4> -->
       <p>Retrouve tout les produits foot destinés aux <a href=""><span style="color: #db4444;">enfants</span></a> ! Que ce soit les  :<a href=""><span style="color: #db4444;">maillots de foot enfants</span></a>, des équipes les plus populaires.</p>
    </div>
    ...
    <section class="py-5">
        <div class="container">
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-50">
                <img src="assets/imgs/produits/maillot enfant/image 98.png" class="card-img-top" alt="Produit 1"><a href="#" class="btn btn-dark"> Maillot</a>
<!--                 <div class="card-body">
                  <h5 class="card-title"></h5>
                  <p class="card-text"> </p>
                  <p class="card-text"> </p>
                  <a href="#" class="btn btn-primary"> </a>
                  <p class="card-text mt-2"><span style="text-decoration: line-through;font-weight: normal;"> </span> </p> 
                </div> -->
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/maillot enfant/image 100.png" class="card-img-top" alt="Produit 2"><a href="#" class="btn btn-dark"> Nouveau</a>
<!--                 <div class="card-body">
                    <h5 class="card-title"> </h5>
                    <p class="card-text"> </p>
                    <p class="card-text"> </p>
...
<!--             <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/3.jpg" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title"> </h5>
                    <p class="card-text"> </p>
                    <p class="card-text"> </p>
    ...
    <section class="py-5">
            <div class="container">
              <div class="row " style="color: black; ">
                <h1 class="mb-3">Boutique football pour les enfants</h1>
                <p>

                    Cette catégorie est dédiée aux <strong>maillots de football pour les enfants.</strong>  <br><br>
                    
                    Il n'est forcément facile pour les parents de trouver les <strong> maillots de football adaptés pour leurs enfants. </strong> <br><br>
                    
                    C'est pour quoi sur Foot-PRO, nous proposons de regrouper tous ces produits dans cette <br> catégorie boutique dédiée, il est alors plus facile d'avoir une vue d'ensemble sur tout ce que <br> nous pouvons offrir aux jeunes joueurs et joueuses de football.<br><br>
                    
                    Grâce aux <strong>filtres </strong>, il est facile de <strong>trouver tous les maillots disponibles</strong> pour un <strong>âge</strong> ou une <strong>taille précise. </strong>  <br><br>
                    Dans cette catégorie dédiée aux enfants, les maillots conviennent à des <strong>enfants <br> de moins de 10 ans ou à des jeunes jusqu'à 16 ans.</strong></p>
              </div>
            </div>
    </section>
    <!--fin-->
    ...
    <!--  image -->
    <div>
      <img src="assets/imgs/produits/maillot enfant/image 99.png" class="img-fluid" alt="Wild Landscape" /> 
    </div>
    <!--  image -->
