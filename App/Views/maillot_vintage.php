...
<html lang="en">
  ...
  <body>
    ...
    <!--  image -->
    <div>
        <img src="assets/imgs/produits/vintage/image 91.png" class="img-fluid" alt="Wild Landscape" /> 
    </div>
    <!--  image -->
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="<?= URL ?>Accueil"><span style="color: #db4444;">Accueil</span></a>/ <a href="" style="color: black;">Vintage</a> / <a href="" style="color: black;"><!--un truc au bon vouloir--></a>  <a href=""><span style="color: #db4444;"><!--un truc au bon vouloir--></span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillot de foot vintage et rétro</h1>
<!--         <h4 class="mb-3"> </h4> -->
       <p> </p> <br>
       <p> Les maillots <a href=""><span style="color: #db4444;">Vintage</span></a> de foot pro ! <br> vous êtes un fan inconditionnel de footballet que vous recherchier des <a href=""><span style="color: #db4444;">maillots légendaire</span></a> des plus <br> <a href=""><span style="color: #db4444;">grand clubs</span></a> et des plus <a href=""><span style="color: #db4444;">grand nations</span></a>, alors <a href=""><span style="color: #db4444;">foot pro</span></a> a tout pour vous rendre heureux</p>
     </div>

    <!--produits-->
    <section class="py-5">
      <div class="position-relative">
          <img src="assets/imgs/produits/vintage/image 92.png" class="img-fluid" alt="Wild Landscape">
          <button class="btn btn-dark position-absolute bottom-0 start-0" style="padding: 20px 50px; margin-left: 20px; margin-bottom: 20px;">Maillot Vintage</button>
      </div>
  </section>
    ...
    <!--fin-->
      <!--boutton-->
      <div class="text-center">
        <a  class="btn-pinki btn-outline-light btn-lg" href="#!" role="button" style="color: white; border:solid; border-color: black; ">Voir tous les produits</a>
      </div>
      <!--fin-->
    ...
    <section class="py-5">
            <div class="container">
              <div class="row " style="color: black;">
                <h1 class="mb-3">Maillot de foot Vintage - Maillot Retro</h1>
                <p>

                    si <strong>vous êtes un fan inconditionnel de football</strong>et que vous recherchez des <strong>maillots rétro</strong> de <strong>mmarques célèbres,</strong> alors Foot-Pro est l'endroit idéal pour vous. <br><br>
                    
                    Nous proposons une large sélection de  <strong> maillots vintage </strong> de marque comme <strong style="color: black;"><a href="#" style="color: black;">PUMA</a>,<a href="#" style="color: black;">ADIDAS</a>,<a href="#" style="color: black;">NIKE</a></strong> et bien d'autre encore. <br><br>
                    
                    Les maillots rétro de ces marques sont une <strong>véritable pièce de collection</strong> pour les fans de football. <br><br>
                    
                    Ils rappellent les momments les plus importants de <strong>l'histoire du football,</strong> les matchs légendaires et les marques les plus emblématiques de chaque époque. <br><br>
                    
                    Chez Foot-Pro,nous proposons des <strong>maillots des marques les plus prestigieuse du football.</strong> pour les fans de football. <br><br>

                    les <strong>maillots rétro</strong> de ces marques sont également parfait pour les collectionneurs football.<br><br>
                   
                    Il peuvent être utilisé pour <strong>compléter une collection</strong> de <strong>maillot de footbal</strong> de tous les clubs et de toutes les nation. <br><br>

                    Nous avons des <strong>maillots des championnats les plus prestigieuse</strong> tels que la <strong style="color: black;"><a href="#" style="color: black;">LIGA</a>,<a href="#" style="color: black;">LIGUE1</a>,et la<a href="#" style="color: black;">Série A</a></strong> <br><br>
    ...
    <!--  image -->
    <div            class="text-center">
      <img src="assets/imgs/produits/vintage/image 93.png" class="img-fluid" alt="Wild Landscape" /> 
    </div>
    <!--  image -->
