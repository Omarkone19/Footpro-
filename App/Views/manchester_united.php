...
<body>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="Accueil"><span style="color: #db4444;">Accueil</span></a>/ <a href="Equipes" style="color: #db4444;">Equipes</a> / <a href="premier_league" style="color: #db4444;">Première League</a> / <a href=""><span style="color: #db4444;">Manchester United</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football de Manchester United</h1>
        <h4 class="mb-3">2023/2024</h4>
       <p>Les <a href=""><span style="color: #db4444;">maillots football</span></a> des clubs de Première league sont répertorié dans cette catégorie :<a href=""><span style="color: #db4444;">Manchester United</span></a>,<a href=""><span style="color: #db4444;">Liverpool</span></a>,<a href=""><span style="color: #db4444;">Arsenal FC </span></a>,<a href=""><span style="color: #db4444;">Chelsea FC</span></a>,<a href=""><span style="color: #db4444;">...</span></a></p>
    </div>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/manchester united 1.jpg" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">ADIDAS</h5>
                  <p class="card-text">Maillots Domicile Manchester United</p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_united_domicile" class="btn btn-primary">Plus de détails</a>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/manchester united 2.jpg" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">ADIDAS</h5>
                    <p class="card-text">Maillots Extérieur authentique Manchester United</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_united_ext" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/manchester united 3.jpeg" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">ADIDAS</h5>
                    <p class="card-text">Maillots Third authentique Manchester United</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_united_third" class="btn btn-primary">Plus de détails</a>
