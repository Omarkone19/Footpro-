...
<body>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
          <h5> <a href="index.html"><span style="color: #db4444;">Accueil</span></a>/ <a href="en_cours.html" style="color: #db4444;">Equipes</a> / <a href="lige1.html" style="color: #db4444;">Ligue 1</a> / <a href="marseille.html"><span style="color: #db4444;">Marseille</span></a> </h5>
        </div>
        <!-- fin -->
    </section>

    <div class="text-center">
        <h1 class="mb-3">Maillots de football de Marseille</h1>
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/Marseille 1.jpg" class="card-img-top" alt="Produit 1">
                <div class="card-body">
                  <h5 class="card-title">PUMA</h5>
                  <p class="card-text">Maillots Domicile authentique Marseille</p>
                  <p class="card-text">2023/2024</p>
                  <a href="product_om_domicile.html" class="btn btn-primary">Plus de détails</a>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/Marseille 2.jpg" class="card-img-top" alt="Produit 2">
                <div class="card-body">
                    <h5 class="card-title">PUMA</h5>
                    <p class="card-text">Maillots Extérieur authentique Marseille</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_om_ext.html" class="btn btn-primary">Plus de détails</a>
                    <p class="card-text mt-2">À partir de : <span style="text-decoration: line-through;font-weight: normal;">105,00€</span> 90,00€</p>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="assets/imgs/produits/liste/Marseille 3.jpg" class="card-img-top" alt="Produit 3">
                <div class="card-body">
                    <h5 class="card-title">PUMA</h5>
                    <p class="card-text">Maillots Third authentique Marseille</p>
                    <p class="card-text">2023/2024</p>
                    <a href="product_om_third.html" class="btn btn-primary">Plus de détails</a>
