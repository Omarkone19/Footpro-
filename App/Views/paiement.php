...
<body>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 " style="color: black;">
        ...
        <div class="me-5 d-none d-lg-block">
            <h5> <a href="Panier"><span style="color: #db4444;">Panier</span></a> > <a href="detail" style="color: #db4444;">Détails </a> > <a href="expediction" style="color: #db4444;">Expédiction </a> > <a href="paiement"><span style="color: #db4444">Paiement</span></a> </h5>
        </div>
        <!-- fin -->
    </section>
            ...
            <div class="col-md-6 offset-md-1">
                <table class="table align-middle">
                    <tbody>
                      ...
                      <tr>
                        <td>Méthode: Livraison standard-GRATUITE</td>
                        <td><a href="" class="btn btn-sm " style="color: #db4444;" type="button">Modifier</a></td>
                      </tr>
                    </tbody>
                </table><br><br>
                <h4><strong>Moyen de Paiement</strong></h4>
                <div class="card payment-form">
                    <div class="card-header text-white " style="background-color: #db4444;">
                        <h5 class="card-title mb-0">Moyen de Paiement <i class="far fa-credit-card"></i></h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cardNumber" placeholder="Numéro de carte : 1234 5678 9012 3456">
                            </div>
                            <div class="mb-3">
                                <!-- <label for="cardHolder" class="form-label">Nom du titulaire de la carte</label> -->
                                <input type="text" class="form-control" id="cardHolder" placeholder="Nom du titulaire de la carte : Léo Messi">
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <!-- <label for="expDate" class="form-label">Date d'expiration</label> -->
                                    <input type="text" class="form-control" id="expDate" placeholder="Date d'expiration : MM/AA">
                                </div>
                                <div class="col">
                                    <!-- <label for="cvv" class="form-label">CVV</label> -->
                                    <input type="text" class="form-control" id="cvv" placeholder="CVV :123">
                                </div>
                            </div>
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="sameAddress">Indiquer a l'adresse de livraison</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="saveAddress">
                  <label class="form-check-label" for="saveAddress">Utiliser une adresse différente pour la facturation</label>
                </div>

                <div class="d-flex justify-content-between mt-5">
                    <a href="expediction.html" type="button" class="btn " style="color: #db4444;">
                        <i class="fas fa-arrow-left me-1"></i> Retour à l'expédition
                    </a>
                    <button type="button" class="btn " style="background-color: #db4444; color: white;">
                        Payer maintenant
                    </button>
                </div>
            </div>
