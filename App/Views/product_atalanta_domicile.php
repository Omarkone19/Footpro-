        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="d-flex flex-column ">
                    <img src="assets/imgs/Maillot/atalanta1.jpeg" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/atalanta2.jpeg" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/atalanta3.jpeg" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/atalanta4.jpeg" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>
            ...
            <div class="col-md-4">
                ...
                <div class="selected-img">
                    <img src="assets/imgs/Maillot/atalanta1.jpeg" alt="Maillot Chelsea Third" style="height: 500px; width: 350px; border: 20px solid #ccc;">
            ...
            <div class="col-md-4 " style="">
                <h2>JOMA
                    Maillots Domicile authentique Atalanta Bergame
            ...
            <div class="rating" style="margin-top: 20px;">
                ...
                <div class="d-flex justify-content-between ">
                    <div class="quantity mt-4">
                        ...
                        <a href="panier.html" style="display: inline-block; margin-top: -60px;">
                            <button style="height: 40px; background-color: #db4444; color: white; margin-left: 50px;" class="btn mt-3"><i class="fas fa-shopping-cart"></i>+ Ajouter au panier</button>
                        </a>
