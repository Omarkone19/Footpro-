        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="d-flex flex-column ">
                    <img src="assets/imgs/Maillot/lens1.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/lens2.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/lens3.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/lens4.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>
            ...
            <div class="col-md-4">
                ...
                <div class="selected-img">
                    <img src="assets/imgs/Maillot/lens1.avif"alt="Maillot Chelsea Third" style="height: 500px; width: 350px; border: 20px solid #ccc;">
            ...
            <div class="col-md-4 " style="">
                <h2>PUMA
                    Maillots Domicile authentique Lens
