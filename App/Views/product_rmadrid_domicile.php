        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="d-flex flex-column ">
                    <img src="assets/imgs/Maillot/real1.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/real2.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/real3.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>

                    <img src="assets/imgs/Maillot/real4.avif" alt="" style="height: 100px; width: 150px; border: 2px solid #db4444;"><br>
            ...
            <div class="col-md-4">
                ...
                <div class="selected-img">
                    <img src="assets/imgs/Maillot/real1.avif"alt="Maillot Chelsea Third" style="height: 500px; width: 350px; border: 20px solid #ccc;">
            ...
            <div class="col-md-4 " style="">
                <h2>ADIDAS
                    Maillots Domicile authentique Réal Madrid
